...
<head>
	...
	<title>Health Med Labs || User Cancel Appointment Detail</title>
			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">User Cancel Appointment</h4>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table class="table table-bordered table-hover js-basic-example dataTable table-custom">
								...
								<tbody>
                  <?php
$sql="SELECT * from  tblappointment where Status='Appointment Cancelled'";
