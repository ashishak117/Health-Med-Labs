...
<head>
	...
	<title>Health Med Labs || Uploaded Reports Detail</title>
			...
			<div class="col-md-12">
				<div class="widget">
					<header class="widget-header">
						<h4 class="widget-title">Uploaded Reports Detail</h4>
					...
					<div class="widget-body">
						<div class="table-responsive">
							<table class="table table-bordered table-hover js-basic-example dataTable table-custom">
								...
								<tbody>
                  <?php
$sql="SELECT * from  tblappointment where Status='Report Uploaded'";
