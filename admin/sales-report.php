...
<head>
  ...
  <title>Health Med Labs - Sales Report</title>
      ...
      <div class="col-md-12">
        <div class="widget">
          ...
          <div class="widget-body">
            ...
            <form class="form-horizontal" method="post" name="" action="sales-reports-detailed.php">
              ...
              <div class="form-group">
                <label for="email2" class="col-sm-3 control-label">Request Type:</label>
                <div class="col-sm-9">
