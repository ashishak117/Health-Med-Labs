...
<head>
  ...
  <title>Health Med Labs - Sample Collection Report</title>
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title"> Sample Collection Report</h3>
          </header><!-- .widget-header -->
          <hr class="widget-separator">
          <div class="widget-body">
           
            <form class="form-horizontal" method="post" name="" action="sample-collected-report.php">
