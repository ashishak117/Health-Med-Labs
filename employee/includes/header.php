...
{ 
  ...
  ?>
            ...
            <a href="view-assigned-appointment-detail.php?editid=<?php echo $row->ID;?>&&aptid=<?php echo $row->AppointmentNumber;?>" class="media-group-item">
              <div class="media">
                ...
                <div class="media-body">
                  <h5 class="media-heading">New Assign Appointment</h5>
                  <small class="media-meta"><?php echo $row->AppointmentNumber;?> at (<?php echo $row->PostDate;?>)</small>
                </div>
              </div>
            </a><!-- .media-group-item -->
        <?php  } ?>
