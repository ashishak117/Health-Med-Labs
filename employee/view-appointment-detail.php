...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 ...
 echo "<script>window.location.href ='view-appointment-detail.php'</script>";
}
  ?>
<!DOCTYPE html>
<html lang="en">
...
{
  echo "Lab assistance on the way";
}

if($row->Status=="Sample Collected")
{
 echo "Your Sample has been Collected";
}


if($row->Status=="Delivered to Lab")
{
  echo "Sample Reached to Lab";
}
...
<th >Prescription</th>
    <td colspan="3" ><img src="user/images/<?php echo $row->Prescription;?>" width="200" height="150"></td>
  </tr>
