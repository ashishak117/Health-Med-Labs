...
$sql ="SELECT ID FROM tblemployee WHERE ID=:eid and Password=:cpassword";
...
if($query -> rowCount() > 0)
{
$con="update tblemployee set Password=:newpassword where ID=:eid";
...
<head>
  ...
  <title>Health Med Labs - Change Password</title>
